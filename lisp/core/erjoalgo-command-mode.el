...
(buttons-macrolet
  ...
  (defbuttons
    ...
    (buttons-make
     ...
     ((kbd "S-<insertchar>") 'other-window);;originally C-x o
     ...
     ("m"
      (buttons-make
       ...
       ("A" (file "~/git/autobuild/common-rules/autobuild-common-rules.el"))
       ("S" (file "/home/ealfonso/git/dotemacs/lisp/core/devscene.el"))
...
(buttons-macrolet
  ...
  (define-key global-map (kbd "<insertchar>") nil)
  ...
  (defbuttons command-mode-global-buttons
    ...
    (but
     ...
     ((kbd "<insertchar>") 'global-erjoalgo-command-mode-toggle)
